export const homePageDescription = {
  ...
  fourthParagraph: 'Je cherche actuellement un poste de développeur front end junior sur Marseille ou en télétravail.',
  fifthParagraph: 'Passionné par l’informatique et les voyages, je parle couramment l’anglais et le chinois. Adepte de la cuisine asiatique, j’aime également le fitness et les sports extrêmes.'
}